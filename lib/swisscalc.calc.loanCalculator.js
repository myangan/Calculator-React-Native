...
global.swisscalc.calc.loanCalculator.prototype.getDownPaymentPercent =
  function () {
    return (this.getDownPayment() / this.getLoanAmount()) * 100.0;
  };
global.swisscalc.calc.loanCalculator.prototype.getInterestRateDecimal =
  function () {
    return this._interestRate.getDisplayValue() / 100.0;
  };
global.swisscalc.calc.loanCalculator.prototype.getInterestRatePercentage =
  function () {
...
global.swisscalc.calc.loanCalculator.prototype.setDownPaymentPercent =
  function (perc) {
    this._downPayment.setDisplayValue((perc / 100.0) * this.getLoanAmount());
  }; // Set down payment as percentage of loan
global.swisscalc.calc.loanCalculator.prototype.setInterestRateDecimal =
  function (decimal) {
    this._interestRate.setDisplayValue(decimal * 100);
  }; // Set interest rate as a decimal
global.swisscalc.calc.loanCalculator.prototype.setInterestRatePercentage =
  function (perc) {
...
global.swisscalc.calc.loanCalculator.prototype.getLoanAmountDisplay =
  function () {
    return global.swisscalc.lib.format.asUSCurrency(this.getLoanAmount());
  };
global.swisscalc.calc.loanCalculator.prototype.getDownPaymentDisplay =
  function () {
    return global.swisscalc.lib.format.asUSCurrency(this.getDownPayment());
  };
global.swisscalc.calc.loanCalculator.prototype.getInterestRateDisplay =
  function () {
